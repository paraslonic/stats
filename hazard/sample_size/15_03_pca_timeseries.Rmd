...
#n_vals <- c(500,1000,3000,6000,10000)
...
for (n in n_vals){
  ...
  success_rate[[n]] <- sum(p_vals<0.001)/500
}
...
plot(n_vals[1:6], unlist(success_rate)[1:6], type="l", lwd = 3, frame.plot = F,
     ylab="доля тестов с p-value < 0.001", xlab="размер выборки", ylim = c(0,0.2))
abline(h=0.95)
abline(h=0.9)
abline(h=0.99)
```